...
## Testing the Connection
 ...
 In order to test that the GitHub downloaded succeeded, I had the turtle run the following script:
```lua
for i =  1,  6
	do turtle.forward() 
end
```
which seems to have run quite well.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1OTM3MzM0NDgsOTI5ODQxMTEzLC0xMD
IwNDU0MTM4XX0=
-->