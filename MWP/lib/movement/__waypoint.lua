...
waypointTask = {}
function waypointTask:new(name, loc)

    local wp = waypoint:new(name,loc)
    local obj = task2.task:new(name, nil, wp.go)

    -- Now merge the properties of wp into obj:
